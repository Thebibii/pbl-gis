                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-slate-50/50 border-b border-border">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-muted-foreground">Nama Prestasi</th>
                            <th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-muted-foreground w-32">Tingkat</th>
                            <th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-muted-foreground w-32">Jenis</th>
                            <th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-muted-foreground w-24">Tahun</th>
                            <th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-muted-foreground w-36 text-right">Aksi</th>
                        </tr>
                    </thead>
